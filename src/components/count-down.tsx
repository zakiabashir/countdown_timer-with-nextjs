...
export default function Countdown() {
  ...
  return (
    ...
    <div className="flex flex-col items-center justify-center h-screen bg-gradient-to-r from-blue-300  to-red-300 dark:bg-gray-900">
      {/* Timer box container */}
      <div className="bg-gradient-to-r from-red-300  to-blue-300 dark:bg-gray-800 shadow-lg rounded-lg p-8 w-full max-w-md box-shadow: rgba(0, 0, 0, 0.25) 0px 54px 55px, rgba(0, 0, 0, 0.12) 0px -12px 30px, rgba(0, 0, 0, 0.12) 0px 4px 6px, rgba(0, 0, 0, 0.17) 0px 12px 13px, rgba(0, 0, 0, 0.09) 0px -3px 5px;">
        ...
        <div className="flex items-center mb-6">
          <Input
            ...
            className="flex-1 mr-4 rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200 bg-gradient-to-r from-pink-300  to-gray-400"
          />
          <Button
            onClick={handleSetDuration}
            variant="outline"
            className="text-gray-800 dark:text-gray-200 bg-gradient-to-r from-blue-300  to-red-300"
          >
            Set
          </Button>
        </div>
